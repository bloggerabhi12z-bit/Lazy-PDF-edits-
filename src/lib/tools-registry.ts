...
export const TOOLS: ToolMeta[] = [
  ...
  { slug: "remove-watermark", seoSlug: "remove-watermark-from-pdf", name: "Cover Watermark Area", tagline: "Cover a fixed central area.", description: "Covers a fixed central region on every page; it does not detect or remove arbitrary watermarks.", keywords: ["cover watermark pdf", "hide pdf watermark area"], icon: EraserIcon, accentClass: "from-neutral-200 to-stone-200", status: "ready", category: "edit" },
  ...
  { slug: "word-to-pdf", seoSlug: "word-to-pdf", name: "Word to PDF", tagline: "Convert .docx to PDF.", description: "Render a Word document visually and export it as a PDF.", keywords: ["word to pdf", "docx to pdf", "convert word to pdf", "doc to pdf"], icon: FileType, accentClass: "from-blue-200 to-sky-200", status: "ready", category: "convert-to" },
  ...
  { slug: "powerpoint-to-pdf", seoSlug: "powerpoint-to-pdf", name: "PowerPoint to PDF", tagline: "Convert slides to PDF.", description: "Preserve slide text placement in a visual PDF export.", keywords: ["powerpoint to pdf", "pptx to pdf", "ppt to pdf", "slides to pdf"], icon: Presentation, accentClass: "from-orange-200 to-red-200", status: "ready", category: "convert-to" },
  { slug: "html-to-pdf", seoSlug: "html-to-pdf", name: "HTML to PDF", tagline: "Convert HTML to PDF.", description: "Render styled HTML visually and export it as a PDF.", keywords: ["html to pdf", "convert html to pdf", "webpage to pdf"], icon: Code2, accentClass: "from-slate-200 to-gray-200", status: "ready", category: "convert-to" },
  { slug: "epub-to-pdf", seoSlug: "epub-to-pdf", name: "EPUB to PDF", tagline: "Convert an ebook to PDF.", description: "Render EPUB chapters and embedded styles into a PDF.", keywords: ["epub to pdf", "ebook to pdf", "convert epub"], icon: BookOpen, accentClass: "from-yellow-200 to-amber-200", status: "ready", category: "convert-to" },

    ...
    <div className="min-h-screen"><Header />
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        {!user ? (
          ...
          <>
<div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><div className="text-xs font-semibold uppercase tracking-[0.2em] text-signal">Workspace</div><h1 className="mt-2 font-display text-4xl sm:text-5xl">Good to see you{user.user_metadata.name ? `, ${user.user_metadata.name.split(" ")[0]}` : ""}.</h1><p className="mt-2 text-muted-foreground">A private activity record—never a copy of your files.</p></div><Button asChild><Link to="/tools">Process a new file</Link></Button></div>
